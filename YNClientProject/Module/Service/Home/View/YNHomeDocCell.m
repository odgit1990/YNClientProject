...
{
    _titleLab.text=[WFFunctions WFCheckEmptyBackStr:[sourceDic objectForKey:@"title"]];
    _moreLab.text=[WFFunctions WFCheckEmptyBackStr:[sourceDic objectForKey:@"description"]];
    _autLab.text=[NSString stringWithFormat:@"作者:%@",[WFFunctions WFCheckEmptyBackStr:[sourceDic objectForKey:@"author"]]];
    _timeLab.text=[WFFunctions WFCheckEmptyBackStr:[sourceDic objectForKey:@"createdAt"]];
    [_markIV sd_setImageWithURL:[NSURL URLWithString:[WFFunctions WFCheckEmptyBackStr:[sourceDic objectForKey:@"image"]]] placeholderImage:DefaultImage];
