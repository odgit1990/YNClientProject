...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar lt_setBackgroundColor:[Main_Color_Gold colorWithAlphaComponent:myAlpha]];
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section!=0)
    {
        NSArray* arr=@[@"YNGetMoneyVC",@"YNGetMoneyVC"];
        Class class=NSClassFromString(arr[indexPath.section-1]);
        if (class) {
