...
- (BOOL) isSameWeekAsDate: (NSDate *) aDate
{
	...
	if (components1.weekOfMonth != components2.weekOfMonth || components1.weekOfMonth != components2.weekOfMonth) return NO;
...
{
	NSDateComponents *components = [CURRENT_CALENDAR components:DATE_COMPONENTS fromDate:self];
	return components.weekOfMonth | components.weekOfYear;
}
